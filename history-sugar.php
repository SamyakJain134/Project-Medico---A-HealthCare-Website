    ...
    <script>
        ...
        $module.controller("mycontroller", function($scope, $http, $filter) {
            ...
            $scope.fetchAll = function() {
                ...
                $http.get("history-sugar-process.php?uid=" + $scope.uid + "&dfrom=" + dfrom + "&dto=" + dto).then(Ok, notOk);
...
<body ng-app="mymodule" ng-controller="mycontroller" id="bg">
    ...
    <nav class="navbar navbar-light bg-light">
        <div style="font-size:24px;">
            <img src="pics/agent.jpg" width="80" height="80" alt="">
            SUGAR HISTORY
        </div>
    </nav>
    <br>
    ...
    <center>
        ...
        <table id="table1" class="table table-striped" style="width:1200px;" rules="all">
            <tr>
                <th ng-click="doSort('dateofrecordd');">DATE</th>
